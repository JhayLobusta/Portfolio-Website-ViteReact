...
const App = () => {
  ...
  const words = ["apps.", "sites."];

  return (
    <>
    <div id='bodycursor' className=''><div class="fixed top-0 z-[-2] h-full w-full bg-neutral-950 bg-[radial-gradient(ellipse_80%_80%_at_50%_-20%,rgba(10,100,198,0.3),rgba(255,255,255,0))]"><div class="fixed bottom-0 left-0 right-0 top-0 bg-[linear-gradient(to_right,#2528362e_1px,transparent_1px),linear-gradient(to_bottom,#2528362e_1px,transparent_1px)] bg-[size:8px_8px]"></div></div>
...
<section className="flex flex-col lg:flex-row items-center h-full px-10 max-w-screen-xl md:mx-12 lg:px-0 lg:m-auto lg:h-screen">
  ...
  <div className="relative flex flex-col flex-1">
    ...
    <h1 className="text-6xl font-regular mb-0 leading-tight text-sky-200">I design & build <a className='italic text-sky-400 hover:text-sky-500 transition-all ease-in-out duration-300 inline-block'><FlipWords words={words}/></a></h1>
